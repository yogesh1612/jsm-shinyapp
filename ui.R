...
tabPanel("Overview & Example Dataset",
         ...
         hr(),
         h4(p("Data input format & sample datasets")),
...
below",align="justify"),
         ...
         downloadButton('downloadData1', 'Download Perceptual file example 1'),
         downloadButton('downloadData3', 'Download Perceptual file example 2'),
         img(src = "perceptual.png", height = 180, width = 400),
         br(),
         br(),
         p('Preference Sample File'),
         downloadButton('downloadData2', 'Download Preference file example 1'),
         downloadButton('downloadData4', 'Download Preference file example 2'),
         br(),
...
#tabPanel("Example dataset", ),
                ...
                tabPanel("Data",h5(p("Perceptual Data")),hr(),dataTableOutput("table"),hr(),h5(p("Preference Data")),hr(),dataTableOutput("table1"))
#     tableOutput("table"),  
#     tableOutput("table1"),
